...
<div class="container">
    <table style="width: 40%; " >
      <tbody >
        <tr >
          <td rowspan="2" ><a  href="index.php" style=" text-decoration: none;color: black;margin-left: 18%;"><img src="sknscoeicon.jpg" width="75px"></a></td>
...
<!--  <div class="col-md-12 inner-div"  style="border-left: 1px solid gray;">
  <h6 style="text-align: center;margin-top: 15px; padding-bottom: 6%; padding-left: 2%;padding-right: 2%;" class="bottomhover"> <a  href="guide_Author.php"  role="button"  style="color: black;text-decoration: none;">Guide for authors</a></h6>
...
<div class="mb-3">
  <label for="title" class="form-label">Enter title Of your New volume</label>
